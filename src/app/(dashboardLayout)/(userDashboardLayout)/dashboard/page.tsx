...
//     const handleViewMatch = (matchId: string) => {
//         // Modal or redirect to match details page
...
//                                          <span className="px-3 py-1 rounded text-white text-sm bg-gray-400">No Requests</span>
//                                      ) : (
//                                          Array.from(new Set(trip.joinRequests.map(r => r.status))).map((status, idx) => (<span key={idx}
//                                          className={`px-3 py-1 rounded text-white text-sm mr-1 ${
//                                          status === "PENDING"
//                                          ? "bg-yellow-500"
//                                          : status === "ACCEPTED"
//                                          ? "bg-green-500"
